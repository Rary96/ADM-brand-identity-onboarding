...
function buildRow(
  ...
  return [
    ...
    getOptionLabel("namingStatus", data.namingStatus),
    ...
    join(getOptionLabels("supportiEVincoli", data.supportiEVincoli?.supporti.selezionati)),
    data.supportiEVincoli?.supporti.altro ?? "",
    data.supportiEVincoli?.vincoliTecnici ?? "",
    join(getOptionLabels("formatiRichiesti", data.formatiRichiesti.selezionati)),
    data.formatiRichiesti.altro ?? "",
    getOptionLabel("payoffTagline", data.payoffTagline),
    data.scadenza?.data ?? "",
    data.scadenza?.note ?? "",
    getOptionLabel("budget", data.budget),
    getOptionLabel("decisorFinale", data.decisorFinale),
    data.domandaJolly ?? "",
